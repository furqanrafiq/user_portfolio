...
function UserModal({ isModalOpen, setIsModalOpen, getAllVendors, selectedItem }) {
    ...
    const onFinish = (values) => {
        ...
        return api.post(`${apiURL}/user/${url}`, body)
            .then((res) => {
                notify.success({
                    message: 'Success!',
    ...
    return (
        <>
            <Modal title="User Details" open={isModalOpen} footer={[]} closable={false}>
                <Form
                    name="signin"
                    form={form}
                    onFinish={onFinish}
