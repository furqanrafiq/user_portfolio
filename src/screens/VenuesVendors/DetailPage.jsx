    ...
    return (
        <div className='container mx-auto my-10'>
            <div className='text-center'>
                ...
                <p className='font-serif text-heading'>{service?.name}</p>
                <p className='font-sans text-[16px]'>{service?.location}</p>
            </div>
            ...
            <div className='mt-5 w-[75%] mx-auto'>
                <Row className='justify-between' gutter={24}>
                    <Col md={12}>
                        <p className='font-serif text-heading'>About {service?.name}</p>
                        <p className='font-sans text-[16px]'>{service?.description}</p>
                    </Col>
                    <Col md={8}>
                        <div className='bg-white rounded p-5 font-sans'>
                            <p className='font-serif text-[20px] mb-5'>About {service?.name}</p>
                            <p><PhoneOutlined /> {service?.phoneNumber}</p>
